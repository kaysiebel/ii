...
<div class="bar-container">
    ...
    <div class="accordion-panel block">
        <div class="settings-container margin-16">
            <p class="construction">UNDER <br> CONSTRUCTION</p>
            <p>
                <h1>Impressum</h1>
                <h3>Angaben gemäß § 5 TMG</h3>
                Kay Siebel, Talstraße 25<br>
                203359 Hamburg<br>
                <br>
                <h3>Kontakt</h3>
                Telefon: +49 (0) 160 91 54 14 76<br>
                E-Mail: kasi@gmx.de<br>
                <br>
