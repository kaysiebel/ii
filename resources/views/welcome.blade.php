...
<body>
        ...
        <div class="flex flex-wrap center">
            ...
            <div class="card margin-16 border-radius shadow">
                ...
                <div class="card-content grid center">
                    ...
                    <button class="accordion ripple border-bottom padding-4">i!</button>
                    <div class="accordion-panel border-bottom">
                        <p class="">
    ...
    <style>
        ...
        .ripple:hover {
            background: var(--light) radial-gradient(circle, transparent 1%, var(--dark) 10%) center/15000%;
            color: var(--darkest);
        }
        ...
        .border {
            border: 12px;
            border: medium solid var(--darker);
        }
